    ...
    <div>
      <div id="singlePost">
        <div className="singlePostWrapper">
          <img className="singlePostImg" src="post1.jpeg" alt="" />
          ...
          <p className="singlePostDesc">
            There`s something very special about stumbling across a brand in the magical woodland that is Instagram. Whether that`s checking a tag on
            an outfit the girl you adore is wearing, spotting a share on stories or by chance noticing their little circle icon stand out in a mist of
